...
const services = [
  {
    title: "Corte de chave",
    image: "/image/key cutting machine.jpeg",
    description: "Cópia e corte de chaves para reposição e uso diário.",
  },
  {
    title: "Serviço de chaves",
    image: "/image/keys.jpg",
    description: "Cópias de chaves e apoio simples de chaveiro.",
  },
  {
    title: "Cópias extras",
    image: "/image/keys 2.jpeg",
    description: "Chaves duplicadas com atendimento rápido e prático.",
  },
  {
    title: "Chaveiro",
    image: "/image/key-icon.png",
    description: "Serviços gerais de chaveiro para soluções rápidas.",
  },
]

export default function ChaveiroPage() {
  return (
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-8 max-w-3xl">
            ...
            <h1 className="mt-3 text-3xl font-bold sm:text-5xl">
              Cópia de chaves e chaveiro
            </h1>
            <p className="mt-4 text-base leading-7 text-slate-200 sm:text-lg">
              Cópia, corte de chaves e suporte simples quando você precisar.
            </p>
          </div>
        </div>
      </section>
